...
import (
	...
	errorpb "miniLinkDB/proto/pkg/errorpb"

	metapb "miniLinkDB/proto/pkg/metapb"
)
...
const (
	...
	// The lock does not exist, LinkKV left a record of the rollback, but did not
...
type CheckTxnStatusResponse struct {
	...
	// The action performed by LinkKV in response to the CheckTxnStatus request.
...
// If commit_version is 0, LinkKV will rollback all locks. If commit_version is greater than
